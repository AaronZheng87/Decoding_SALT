...
p <- "/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/3_Plots"
###################################################
############### Logistic Regression ##############
###################################################

####### Current trial
ROC_within_c <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/1_Logistic/1_Current/LR_withinscore_current.csv")
ROC_cross_c <- read_csv(("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/1_Logistic/1_Current/LR_crossscore_current.csv"))
###### trials back
...
################## feature importance####################
### current trial
within_im_current <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/1_Logistic/1_Current/importance_within_current.csv")
cross_im_current <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/1_Logistic/1_Current/importance_cross_current.csv")
### Trials back
