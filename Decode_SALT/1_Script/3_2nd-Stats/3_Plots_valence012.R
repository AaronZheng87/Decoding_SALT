...
p <- "/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/Log_prepro/3_Plots"
###################################################
############### Logistic Regression ##############
###################################################

####### Current trial
ROC_within_c <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/Valence012/1_Logistic/1_Current/LR_withinscore_current.csv")
ROC_cross_c <- read_csv(("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/Log_prepro/1_Logistic/1_Current/LR_crossscore_current.csv"))
###### trials back
ROC_within_tb <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/Valence012/1_Logistic/2_Trials-Back/LR_withinscore.csv")
ROC_cross_tb <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/Valence012/1_Logistic/2_Trials-Back/LR_crossscore.csv")
...
################## feature importance####################
### current trial
within_im_current <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/Log_prepro/1_Logistic/1_Current/importance_within_current.csv")
cross_im_current <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/Log_prepro/1_Logistic/1_Current/importance_cross_current.csv")
### Trials back
within_im_tb <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/1_Logistic/2_Trials-Back/importance_within.csv")
cross_im_tb <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/1_Logistic/2_Trials-Back/importance_cross.csv")
...
### Current trial
ROC_within_c_rf <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/2_Random-forest/1_Current/RF_withinscore_current.csv")
ROC_cross_c_rf <- read_csv(("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/2_Random-forest/1_Current/RF_crossscore_current.csv"))
ROC_within_tb_rf <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/2_Random-forest/2_Trials-Back/RF_withinscore.csv")
ROC_cross_tb_rf <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/2_Random-forest/2_Trials-Back/RF_crossscore.csv")
...
######### feature importance
within_im_c_rf <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/2_Random-forest/1_Current/RF_importance_within_current.csv")
im_ccross_rf <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/2_Random-forest/1_Current/RF_importance_cross_current.csv")
within_im_tb_rf <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/2_Random-forest/2_Trials-Back/RF_importance_within.csv")
cross_im_tb_rf <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/2_Random-forest/2_Trials-Back/RF_importance_cross.csv")
