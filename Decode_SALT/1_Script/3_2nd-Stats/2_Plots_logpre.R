...
####### Current trial
ROC_within_c <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/Log_prepro/1_Logistic/1_Current/LR_withinscore_current.csv")
...
###### trials back
ROC_within_tb <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/1_Logistic/2_Trials-Back/LR_withinscore.csv")
ROC_cross_tb <- read_csv("/Users/zhengyuanrui/Decoding_SALT/Decode_SALT/3_Result/1_Logistic/2_Trials-Back/LR_crossscore.csv")
